...
export const PREFIX_MAP: Record<string, string> = {
  ...
  SPARK_: 'xfyun',
  IFLYTEK_: 'xfyun',
  AWS_BEDROCK_: 'aws_bedrock',
  BEDROCK_: 'aws_bedrock',
  GOOGLE_VERTEX_: 'google_vertex',
  VERTEX_: 'google_vertex',
  AZURE_: 'azure',
  AZURE_OPENAI_: 'azure',
  WATSONX_: 'watsonx',
  IBM_WATSONX_: 'watsonx',
  SCALEWAY_: 'scaleway',
  OLLAMA_LOCAL_: 'ollama_local',
  LMSTUDIO_: 'lmstudio',
  LM_STUDIO_: 'lmstudio',
  LLAMACPP_: 'llamacpp',
  LLAMA_CPP_: 'llamacpp',
  VLLM_: 'vllm',
  LLAMA_API_: 'llama_api',
  LLAMAAPI_: 'llama_api',
  KILO_: 'kilo',
