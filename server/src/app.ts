...
import { providersRouter as apiProvidersRouter, providerAccountsRouter, modelDiscoveryRouter } from './routes/providers.js';
import { storageRouter } from './routes/storage.js';
import { docsRouter } from './routes/docs.js';
import { mcpRouter } from './routes/mcp.js';
import { statusRouter, providersRouter as v1ProvidersRouter } from './routes/status.js';
...
export function createApp(config?: Config) {
  ...
  app.use('/api/providers', requireAuth, apiProvidersRouter);
